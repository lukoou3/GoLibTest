...
func (r *Bcloud) SetAppKey(app_key string) {
	r.app_key = app_key
}

func (r *Bcloud) SetSecret(app_secret string) {
	r.app_secret = app_secret
}

func (r *Bcloud) SetAccessToken(accessToken string) {
	r.accessToken = accessToken
}

func (r *Bcloud) SetRefreshToken(refreshToken string) {
